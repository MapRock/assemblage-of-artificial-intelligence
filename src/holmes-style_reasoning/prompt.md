...
Question:
How did chickens reach pre-Columbian South America (e.g., Chile's Arauco Peninsula)?

Reasoning protocol:

You must use a strict four-part Sherlock Holmes-style process. As Holmes stated:
...
1. INDUCTION
Gather clues and facts only.
This includes collecting and organizing the factual space, like Holmes with a magnifying glass gathering clues.
...
2. ABDUCTION
Abduction begins only after the factual/clue space has been built.
Abduction here does not mean merely “guess the best explanation.”
It means:
...
- documented historical spread dates
- biological properties of transport, propagation, or survival
- ocean current directions and approximate travel constraints
- linguistic distributions
- evidence of human contact
- navigation capabilities
- geography and chronology
- radiocarbon dating quality
- DNA / haplogroup evidence
- contamination risks
- faunal remains and identification issues
...
1. gather facts,
2. organize them into a constrained factual/clue space,
3. generate candidate explanatory structures from that space,
4. deduce consequences from multiple hypotheses,
5. and eliminate carefully without overclaiming.

Do not jump straight to a polished answer.
Show the factual/clue space first.
